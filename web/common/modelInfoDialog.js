...
class MetadataDialog extends ComfyDialog {
    ...
    show(metadata) {
        super.show($el("div", Object.keys(metadata).map((k) => $el("div", [
...
export class ModelInfoDialog extends ComfyDialog {
        ...
        const edit = $el("a", {
            ...
            onclick: async (e) => {
                ...
                if (textarea) {
                    ...
                    (_b = (_a = this.node) === null || _a === void 0 ? void 0 : _a["jk-nodes.updateExamples"]) === null || _b === void 0 ? void 0 : _b.call(_a);
                }
                else {
    ...
    addCivitaiInfo() {
        ...
        return promise
            .then((info) => {
            var _a, _b;
            content.replaceChildren($el("a", {
                href: "https://civitai.com/models/" + info.modelId,
                textContent: "View " + info.model.name,
                target: "_blank",
            }));
            const allPreviews = (_a = info.images) === null || _a === void 0 ? void 0 : _a.filter((i) => i.type === "image");
            const previews = allPreviews === null || allPreviews === void 0 ? void 0 : allPreviews.filter((i) => i.nsfwLevel <= ModelInfoDialog.nsfwLevel);
            if (previews === null || previews === void 0 ? void 0 : previews.length) {
                let previewIndex = 0;
                let preview;
                const updatePreview = () => {
            ...
            else if ((_b = info.images) === null || _b === void 0 ? void 0 : _b.length) {
