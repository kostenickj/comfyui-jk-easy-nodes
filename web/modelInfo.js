...
export class LoraInfoDialog extends ModelInfoDialog {
    getTagFrequency() {
        if (!this.metadata.ss_tag_frequency)
            return [];
    ...
    getResolutions() {
        ...
        if (this.metadata.ss_bucket_info) {
            ...
            if (parsed === null || parsed === void 0 ? void 0 : parsed.buckets) {
    ...
    getTagList(tags) {
        return tags.map((t) => $el("li.jk-nodes-model-tag", {
            dataset: {
                tag: t[0],
            },
            $: (el) => {
    ...
    addTags() {
        ...
        if (!(tags === null || tags === void 0 ? void 0 : tags.length)) {
            tags = (_a = this.metadata["modelspec.tags"]) === null || _a === void 0 ? void 0 : _a.split(",").map((t) => [t.trim(), 1]);
        }
        let hasMore;
        if (tags === null || tags === void 0 ? void 0 : tags.length) {
            const c = tags.length;
    ...
    addPreferredWeightAndActivationText(prefs) {
        const prefWeight = prefs === null || prefs === void 0 ? void 0 : prefs.preferred_weight;
        const prefText = prefs === null || prefs === void 0 ? void 0 : prefs.activation_text;
        const textArea = $el("textarea", {
            textContent: prefText !== null && prefText !== void 0 ? prefText : '',
            style: {
                whiteSpace: "pre-wrap",
                margin: "10px 0",
                color: "#fff",
        ...
        const weight = $el("input", {
            type: "number",
            step: '.05',
            value: prefWeight !== null && prefWeight !== void 0 ? prefWeight : 1.0,
            style: {
                width: "80px"
            },
            onchange: (event) => {
    ...
    async addInfo() {
        ...
        this.addInfoEntry("Resolution", $el("select", this.getResolutions().map((r) => $el("option", { textContent: r }))));
        super.addInfo();
        const p = this.addCivitaiInfo();
        this.addPreferredWeightAndActivationText(this.lora_pref);
        this.addTags();
        const info = await p;
        this.addExample("Trained Words", (_b = (_a = info === null || info === void 0 ? void 0 : info.trainedWords) === null || _a === void 0 ? void 0 : _a.join(", ")) !== null && _b !== void 0 ? _b : "", "trainedwords");
        ...
        $el("div", {
            parent: this.content,
            innerHTML: (_d = (_c = info === null || info === void 0 ? void 0 : info.description) !== null && _c !== void 0 ? _c : this.metadata["modelspec.description"]) !== null && _d !== void 0 ? _d : "[No description provided]",
            style: {
                maxHeight: "250px",
                overflow: "auto",
            },
    ...
    async saveLoraPrefs(activation_text, weight, lora_name) {
        ...
        try {
            ...
            const ext = (_b = (_a = window === null || window === void 0 ? void 0 : window.app) === null || _a === void 0 ? void 0 : _a.enabledExtensions) === null || _b === void 0 ? void 0 : _b.find(x => x.name === 'jk-nodes.AutoCompleter');
            if (ext) {
                ext.setup();
            }
            alert("Saved!");
...
function addInfoOption(node, type, infoClass, widgetNamePattern, opts) {
    ...
    for (const widget of widgets) {
        ...
        if (value === null || value === void 0 ? void 0 : value.content) {
            value = value.content;
        }
        if (!value || value === "None") {
            return;
...
app.registerExtension({
    ...
    setup() {
        app.ui.settings.addSetting({
            ...
            onChange(value) {
                var _a;
                ModelInfoDialog.nsfwLevel = (_a = NsfwLevel[value]) !== null && _a !== void 0 ? _a : NsfwLevel.PG;
            },
        });
    },
    beforeRegisterNodeDef(nodeType) {
        ...
        nodeType.prototype.getExtraMenuOptions = function (_, options) {
            ...
            return getExtraMenuOptions === null || getExtraMenuOptions === void 0 ? void 0 : getExtraMenuOptions.apply(this, arguments);
        };
    },
});
