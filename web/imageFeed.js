...
app.registerExtension({
  ...
  async setup() {
    ...
    const feedLocation = app.ui.settings.addSetting({
      ...
      name: "\u{1F40D} Image Feed Location",
      defaultValue: "bottom",
      type: () => {
        return $el("tr", [
          $el("td", [
            $el("label", {
              textContent: "\u{1F40D} Image Feed Location:"
            })
          ]),
          $el("td", [
            $el(
              ...
              ["left", "top", "right", "bottom", "hidden"].map(
                (m) => $el("option", {
                  value: m,
                  textContent: m,
    ...
    const feedDirection = app.ui.settings.addSetting({
      ...
      name: "\u{1F40D} Image Feed Direction",
      defaultValue: "newest first",
      type: () => {
        return $el("tr", [
          $el("td", [
            $el("label", {
              textContent: "\u{1F40D} Image Feed Direction:"
            })
          ]),
          $el("td", [
            $el(
...
Recommended: "enabled (max performance)" uness images are erroneously deduplicated.`,
      ...
      options: (value) => {
        ...
        return Object.entries(dedupeOptions).map(
          ([k, v]) => ({
            value: v,
            text: k,
            selected: k === value
    ...
    const maxImages = app.ui.settings.addSetting({
      ...
      name: "\u{1F40D} Image Feed Max Images",
