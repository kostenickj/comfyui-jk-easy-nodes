...
var LOAD_STATE, PhotoSwipeEvent, Eventable, Placeholder, Content, MAX_IMAGE_WIDTH, ZoomLevel, PhotoSwipeBase, PhotoSwipeLightbox;
var init_photoswipe_lightbox_esm = __esm({
  "node_modules/.pnpm/photoswipe@5.4.4/node_modules/photoswipe/dist/photoswipe-lightbox.esm.js"() {
    LOAD_STATE = {
      IDLE: "idle",
      LOADING: "loading",
    ...
    PhotoSwipeLightbox = class extends PhotoSwipeBase {
      /**
...
var init_photoswipe_esm = __esm({
  "node_modules/.pnpm/photoswipe@5.4.4/node_modules/photoswipe/dist/photoswipe.esm.js"() {
    ...
    DOMEvents = class {
       ...
       */
      add(target, type5, listener, passive) {
        this._toggleListener(target, type5, listener, passive);
      }
      /**
       ...
       * @param {PoolItem['passive']} [passive]
       */
      remove(target, type5, listener, passive) {
        this._toggleListener(target, type5, listener, passive, true);
      }
      /**
       ...
       */
      _toggleListener(target, type5, listener, passive, unbind, skipPool) {
        if (!target) {
          return;
        }
        const methodName = unbind ? "removeEventListener" : "addEventListener";
        const types = type5.split(" ");
        types.forEach((eType) => {
          if (eType) {
            if (!skipPool) {
              if (unbind) {
